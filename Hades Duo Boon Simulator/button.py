...
def make_picked_row(god, boon, GOD_META):
    ...
    return ft.Container(ft.Row([left, spacer, right]), padding=8, bgcolor="#7F9292", border_radius=6)
...
def pick_boon(e, god_dd, boon_dd, player_boons, picked_column, duo_column, page, GOD_META):
    ...
    if available:
        duo_column.controls.append(ft.Text("🔥 Duo Boons Available:", weight="bold", color="#FFCBD1"))
